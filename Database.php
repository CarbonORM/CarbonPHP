...
class Database
{
    ...
    public static function setUp(bool $refresh = true, bool $cli = false): PDO
    {
        ...
        if (file_exists(static::$setup)) {
            ...
            print '<h3>This build is automatically generated by CarbonPHP. When you add a database be sure to re-execute the <br><br><br><b>>> php index.php buildDatabase</h3>' . PHP_EOL . PHP_EOL;
        }
        if ($refresh) {
            $cli ?: print '<br><br><h2>Refreshing in 6 seconds</h2><script>var t1 = window.setTimeout(function(){ window.location.href = \'' . SITE . '\'; },6000);</script>';
            exit(1);
        }
        return static::database();
    }
    ...
    protected static function new_entity($tag_id, $dependant = null)
    {
        ...
        carbon_tag::Post([
            'tag_id' => $tag_id,    // will end up being the table name generated by >> php index.php buildDatabase
            'entity_id' => $id,
        ]);
