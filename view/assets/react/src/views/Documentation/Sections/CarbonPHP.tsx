      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          <div className={classes.textCenter}>
            ...
            <h4>
              a PHP ^7.4 application tool kit & framework
            </h4>
          </div>
        </GridItem>
        <GridItem xs={12} sm={12} md={12}>
                    ...
                    <GridItem xs={12} sm={12} md={8}>
                      <p>
                        ...
                        <p>In this minimal index.php example the <b>Config\Config::class</b> extends the
                          ...
                          will not
                          be instantiated
                          until CarbonPHP is invoked. For the N00B's this is the ending '();' on line 3. This means
                          all C6
                              ...
                              tabContent: (
                                <>
                                  <p>The code below is just one example of initiating CarbonPHP.
                                    Each method comes with its own advantages and caveat's. Unlike 'The Skinny'
                                    version
              ...
              },
              {
                ...
                tabContent: (
                  <GridContainer justify="center">
                    ...
                    <p>
                      It is recommended to use composers built in PSR-4 autoloader. It is required to load C6 and works
