        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                    <!-- chat item -->
                    <div class="item">
                        <img src="/view/mustache/img/defaults/mom.png" alt="user image" class="online">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="/view/mustache/img/defaults/morgan.png" alt="user image" class="offline">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="/view/mustache/img/defaults/madi.png" alt="user image" class="offline">
...
<script>
    ...
    Carbon(()=> {
        ...
        $(function () {
            ...
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/jquery-ui/jquery-ui.min.js", () => {
            ...
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/moment/min/moment.min.js");
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js");
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/bootstrap-daterangepicker/daterangepicker.js", () => {
            ...
            <!-- jvectormap -->
            $.fn.CarbonJS("/node_modules/admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js", () =>
                $.fn.CarbonJS("/node_modules/admin-lte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js", () => {
                    $('#world-map').vectorMap({
                        map: 'world_mill_en',
            ...
            // Sparkline charts
            <!-- Sparkline -->
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js", () => {
            ...
            <!-- Morris.js charts -->
            $.fn.CarbonJS("/node_modules/admin-lte/bower_components/raphael/raphael.min.js", () =>
                $.fn.CarbonJS("/node_modules/admin-lte/bower_components/morris.js/morris.min.js", () => {
