...
export interface  iCarbon_Comments{
      'parent_id'?: string;'comment_id'?: string;'user_id'?: string;'comment'?: string;
}
  

export interface  iCarbons{
      'entity_pk'?: string;'entity_fk'?: string;'entity_tag'?: string;
}
...
export interface  iCarbon_Location_References{
      'entity_reference'?: string;'location_reference'?: string;'location_time'?: string;
}
  

export interface  iCarbon_Locations{
      'entity_id'?: string;'latitude'?: string;'longitude'?: string;'street'?: string;'city'?: string;'state'?: string;'elevation'?: string;'zip'?: string;
}
  

export interface  iCarbon_Photos{
      'parent_id'?: string;'photo_id'?: string;'user_id'?: string;'photo_path'?: string;'photo_description'?: string;
}
  

export interface  iCarbon_Reports{
      'log_level'?: string;'report'?: string;'date'?: string;'call_trace'?: string;
}
  

export interface  iCarbon_User_Followers{
      'follower_table_id'?: string;'follows_user_id'?: string;'user_id'?: string;
}
...
export interface  iCarbon_User_Messages{
      'message_id'?: string;'from_user_id'?: string;'to_user_id'?: string;'message'?: string;'message_read'?: string;'creation_date'?: string;
}
...
export interface  iCarbon_User_Tasks{
      'task_id'?: string;'user_id'?: string;'from_id'?: string;'task_name'?: string;'task_description'?: string;'percent_complete'?: string;'start_date'?: string;'end_date'?: string;
}
  

export interface  iCarbon_Users{
      'user_username'?: string;'user_password'?: string;'user_id'?: string;'user_type'?: string;'user_sport'?: string;'user_session_id'?: string;'user_facebook_id'?: string;'user_first_name'?: string;'user_last_name'?: string;'user_profile_pic'?: string;'user_profile_uri'?: string;'user_cover_photo'?: string;'user_birthday'?: string;'user_gender'?: string;'user_about_me'?: string;'user_rank'?: string;'user_email'?: string;'user_email_code'?: string;'user_email_confirmed'?: string;'user_generated_string'?: string;'user_membership'?: string;'user_deactivated'?: string;'user_last_login'?: string;'user_ip'?: string;'user_education_history'?: string;'user_location'?: string;'user_creation_date'?: string;
}
  

export interface  iCreation_Logs{
      'uuid'?: string;'resource_type'?: string;'resource_uuid'?: string;
}
  

export interface  iHistory_Logs{
      'uuid'?: string;'resource_type'?: string;'resource_uuid'?: string;'operation_type'?: string;'data'?: string;
}
