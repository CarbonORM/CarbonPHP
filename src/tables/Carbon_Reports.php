...
class Carbon_Reports extends Rest implements iRestNoPrimaryKey
{
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to your columns found in carbon_reports. Remember to regenerate when as all changes  
    ...
    */
    ...
    {   
        ...
        if (array_key_exists('carbon_reports.date', $data)) {
            throw new PublicAlert('The column \'carbon_reports.date\' is set to default to CURRENT_TIMESTAMP. The Rest API does not allow POST requests with columns explicitly set whose default is CURRENT_TIMESTAMP. You can remove to the default in MySQL or the column \'carbon_reports.date\' from the request.');
        }
