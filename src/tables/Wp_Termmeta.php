 ...
 *  static method.
 */
class Wp_Termmeta extends Rest implements iRestSinglePrimaryKey
{
    use RestfulValidations;
    
    public const CLASS_NAME = 'Wp_Termmeta';
    public const CLASS_NAMESPACE = 'CarbonPHP\Tables\\';
    public const TABLE_NAME = 'wp_termmeta';
    public const TABLE_PREFIX = '';
    
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in wp_termmeta. 
    ...
    **/
    public const META_ID = 'wp_termmeta.meta_id'; 

    public const TERM_ID = 'wp_termmeta.term_id'; 

    public const META_KEY = 'wp_termmeta.meta_key'; 

    public const META_VALUE = 'wp_termmeta.meta_value'; 
    ...
    **/
    public const PRIMARY = 'wp_termmeta.meta_id';
    ...
    **/ 
    public const COLUMNS = [
        'wp_termmeta.meta_id' => 'meta_id','wp_termmeta.term_id' => 'term_id','wp_termmeta.meta_key' => 'meta_key','wp_termmeta.meta_value' => 'meta_value',
    ];

    public const PDO_VALIDATION = [
        'wp_termmeta.meta_id' => ['bigint', 'PDO::PARAM_INT', ''],'wp_termmeta.term_id' => ['bigint', 'PDO::PARAM_INT', ''],'wp_termmeta.meta_key' => ['varchar', 'PDO::PARAM_STR', '255'],'wp_termmeta.meta_value' => ['longtext', 'PDO::PARAM_STR', ''],
    ];
...
MYSQL;
    ...
    */
    ...
    {   
        ...
        $term_id = $data['wp_termmeta.term_id'] ?? '0';
        $ref='wp_termmeta.term_id';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $term_id, $term_id === '0')) {
            return self::signalError('Your custom restful api validations caused the request to fail on column \'wp_termmeta.term_id\'.');
        }
        $stmt->bindValue(':term_id', $term_id, PDO::PARAM_INT);
        
        $meta_key = $data['wp_termmeta.meta_key'] ?? null;
        $ref='wp_termmeta.meta_key';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $meta_key, $meta_key === null)) {
            return self::signalError('Your custom restful api validations caused the request to fail on column \'wp_termmeta.meta_key\'.');
        }
        $stmt->bindParam(':meta_key',$meta_key, PDO::PARAM_STR, 255);
        
        if (!array_key_exists('wp_termmeta.meta_value', $data)) {
            return self::signalError('The column \'wp_termmeta.meta_value\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_termmeta.meta_value';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['meta_value'])) {
            return self::signalError('Your custom restful api validations caused the request to fail on column \'wp_termmeta.meta_value\'.');
        }
        $stmt->bindValue(':meta_value', $data['wp_termmeta.meta_value'], PDO::PARAM_STR);
        ...
        if (self::$commit && !Database::commit()) {
            return self::signalError('Failed to store commit transaction on table wp_termmeta');
        }
    ...
    public static function Put(array &$returnUpdated, string $primary = null, array $argv = []) : bool
    {
        ...
        foreach ($argv as $key => &$value) {
            ...
            if (!self::validateInternalColumn(self::PUT, $key, $op, $value)) {
                return self::signalError('Your custom restful api validations caused the request to fail on column \'wp_termmeta.\'.');
            }
        }
        unset($value);

        $sql = /** @lang MySQLFragment */ 'UPDATE wp_termmeta SET '; // intellij cant handle this otherwise

        $set = '';

        if (array_key_exists('wp_termmeta.meta_id', $argv)) {
            $set .= 'meta_id=:meta_id,';
        }
        if (array_key_exists('wp_termmeta.term_id', $argv)) {
            $set .= 'term_id=:term_id,';
        }
        if (array_key_exists('wp_termmeta.meta_key', $argv)) {
            $set .= 'meta_key=:meta_key,';
        }
        if (array_key_exists('wp_termmeta.meta_value', $argv)) {
        ...
        if (array_key_exists('wp_termmeta.meta_id', $argv)) { 
            $stmt->bindValue(':meta_id',$argv['wp_termmeta.meta_id'], PDO::PARAM_INT);
        }
        if (array_key_exists('wp_termmeta.term_id', $argv)) { 
            $stmt->bindValue(':term_id',$argv['wp_termmeta.term_id'], PDO::PARAM_INT);
        }
        if (array_key_exists('wp_termmeta.meta_key', $argv)) { 
            $meta_key = $argv['wp_termmeta.meta_key'];
            $ref = 'wp_termmeta.meta_key';
            $op = self::EQUAL;
        ...
        if (array_key_exists('wp_termmeta.meta_value', $argv)) { 
            $stmt->bindValue(':meta_value',$argv['wp_termmeta.meta_value'], PDO::PARAM_STR);
        }
        ...
        $argv = array_combine(
            array_map(
                static fn($k) => str_replace('wp_termmeta.', '', $k),
                array_keys($argv)
            ),
            array_values($argv)
        );
    ...
    */
    public static function Delete(array &$remove, string $primary = null, array $argv = []) : bool
    {
        ...
        $sql =  /** @lang MySQLFragment */ 'DELETE FROM wp_termmeta ';
