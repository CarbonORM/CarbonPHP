...
class Carbon_User_Followers extends Rest implements iRest
{
    ...
    */
    public static function Get(array &$return, string $primary = null, array $argv): bool
    {
        ...
        if (!$stmt->execute()) {
            throw new PublicAlert('Failed to execute the query on Carbon_User_Followers.');
        }
    ...
    public static function Post(array $argv, string $dependantEntityId = null)
    {
        ...
        $follower_table_id = $id = $argv['carbon_user_followers.follower_table_id'] ?? self::beginTransaction('carbon_user_followers', $dependantEntityId);
    ...
    public static function validateSelectColumn($column) : bool {
        return (bool) preg_match('#(((((hex|argv|count|sum|min|max) *\(+ *)+)|(distinct|\*|\+|-|/| |carbon_user_followers||\.follower_table_id|\.follows_user_id|\.user_id))+\)*)+ *(as [a-z]+)?#i', $column);
    }
    ...
    public static function buildSelectQuery(string $primary = null, array $argv, PDO $pdo = null, bool $noHEX = false) : string 
    {
        ...
        if (null === $primary) {
            ...
            if (!empty($where)) {
                $sql .= ' WHERE ' . self::buildWhere($where, $pdo, 'carbon_user_followers', self::PDO_VALIDATION);
            }
        } else {
            $sql .= ' WHERE  follower_table_id=UNHEX('.self::addInjection($primary, $pdo, 'carbon_user_followers').')';
        }
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        if (!$stmt->execute()) {
            throw new PublicAlert('Restful table Carbon_User_Followers failed to execute the update query.');
        }
    ...
    */
    public static function Delete(array &$remove, string $primary = null, array $argv) : bool
    {
        ...
        $sql .= ' WHERE ' . self::buildWhere($argv, $pdo, 'carbon_user_followers', self::PDO_VALIDATION);
