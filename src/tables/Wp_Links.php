...
class Wp_Links extends Rest implements iRestSinglePrimaryKey
{
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to your columns found in wp_links. Remember to regenerate when as all changes  
    ...
    */
    ...
    {   
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_url, $link_url === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_url\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_name, $link_name === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_name\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_image, $link_image === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_image\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_target, $link_target === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_target\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_description, $link_description === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_description\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_visible, $link_visible === 'Y')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_visible\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_rating, $link_rating === '0')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_rating\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_updated, $link_updated === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_updated\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_rel, $link_rel === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_rel\'.');
        }
        $stmt->bindParam(':link_rel',$link_rel, PDO::PARAM_STR, 255);
        
        if (!array_key_exists('wp_links.link_notes', $data)) {
            throw new PublicAlert('The column \'wp_links.link_notes\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_links.link_notes';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['link_notes'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_notes\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $link_rss, $link_rss === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.link_rss\'.');
        }
        ...
        if (self::$commit && !Database::commit()) {
           throw new PublicAlert('Failed to store commit transaction on table wp_links');
        }
    ...
    public static function Put(array &$returnUpdated, string $primary, array $argv) : bool
    {
        ...
        foreach ($argv as $key => &$value) {
            ...
            if (!self::validateInternalColumn(self::PUT, $key, $op, $value)) {
                throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_links.\'.');
            }
        }
        unset($value);
