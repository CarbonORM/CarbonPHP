...
class Wp_Posts extends Rest implements iRestSinglePrimaryKey
{
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to your columns found in wp_posts. Remember to regenerate when as all changes  
    ...
    */
    ...
    {   
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_date, $post_date === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_date\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_date_gmt, $post_date_gmt === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_date_gmt\'.');
        }
        $stmt->bindValue(':post_date_gmt', $post_date_gmt, PDO::PARAM_STR);
        
        if (!array_key_exists('wp_posts.post_content', $data)) {
            throw new PublicAlert('The column \'wp_posts.post_content\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.post_content';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['post_content'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_content\'.');
        }
        $stmt->bindValue(':post_content', $data['wp_posts.post_content'], PDO::PARAM_STR);
        
        if (!array_key_exists('wp_posts.post_title', $data)) {
            throw new PublicAlert('The column \'wp_posts.post_title\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.post_title';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['post_title'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_title\'.');
        }
        $stmt->bindValue(':post_title', $data['wp_posts.post_title'], PDO::PARAM_STR);
        
        if (!array_key_exists('wp_posts.post_excerpt', $data)) {
            throw new PublicAlert('The column \'wp_posts.post_excerpt\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.post_excerpt';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['post_excerpt'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_excerpt\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_status, $post_status === 'publish')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_status\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_status, $comment_status === 'open')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.comment_status\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $ping_status, $ping_status === 'open')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.ping_status\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_password, $post_password === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_password\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_name, $post_name === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_name\'.');
        }
        $stmt->bindParam(':post_name',$post_name, PDO::PARAM_STR, 200);
        
        if (!array_key_exists('wp_posts.to_ping', $data)) {
            throw new PublicAlert('The column \'wp_posts.to_ping\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.to_ping';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['to_ping'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.to_ping\'.');
        }
        $stmt->bindValue(':to_ping', $data['wp_posts.to_ping'], PDO::PARAM_STR);
        
        if (!array_key_exists('wp_posts.pinged', $data)) {
            throw new PublicAlert('The column \'wp_posts.pinged\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.pinged';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['pinged'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.pinged\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_modified, $post_modified === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_modified\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_modified_gmt, $post_modified_gmt === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_modified_gmt\'.');
        }
        $stmt->bindValue(':post_modified_gmt', $post_modified_gmt, PDO::PARAM_STR);
        
        if (!array_key_exists('wp_posts.post_content_filtered', $data)) {
            throw new PublicAlert('The column \'wp_posts.post_content_filtered\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_posts.post_content_filtered';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['post_content_filtered'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_content_filtered\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $guid, $guid === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.guid\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $menu_order, $menu_order === '0')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.menu_order\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_type, $post_type === 'post')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_type\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $post_mime_type, $post_mime_type === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.post_mime_type\'.');
        }
        ...
        if (self::$commit && !Database::commit()) {
           throw new PublicAlert('Failed to store commit transaction on table wp_posts');
        }
    ...
    public static function Put(array &$returnUpdated, string $primary, array $argv) : bool
    {
        ...
        foreach ($argv as $key => &$value) {
            ...
            if (!self::validateInternalColumn(self::PUT, $key, $op, $value)) {
                throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_posts.\'.');
            }
        }
        unset($value);
