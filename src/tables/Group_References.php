...
MYSQL;
    ...
    */
    public static function Put(array &$returnUpdated,  array $argv = []) : bool
    {
        ...
        $sql = /** @lang MySQLFragment */ ($replace ? self::REPLACE : self::UPDATE) . ' carbon_group_references SET '; // intellij cant handle this otherwise
        ...
        $argv = array_combine(
            array_map(
                static fn($k) => str_replace('carbon_group_references.', '', $k),
                array_keys($argv)
            ),
            array_values($argv)
        );
    ...
    */
    public static function Delete(array &$remove, array $argv = []) : bool
    {
        ...
        $sql =  /** @lang MySQLFragment */ 'DELETE FROM carbon_group_references ';
