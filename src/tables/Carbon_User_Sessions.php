...
class Carbon_User_Sessions extends Rest implements iRest
{
    ...
    {
        $inject = ':injection' . count(self::$injection) . 'carbon_user_sessions';
    ...
    */
    ...
    public static function validateSelectColumn($column) : bool {
        return (bool) preg_match('#(((((hex|argv|count|sum|min|max) *\(+ *)+)|(distinct|\*|\+|-|/| |carbon_user_sessions\.user_id|carbon_user_sessions\.user_ip|carbon_user_sessions\.session_id|carbon_user_sessions\.session_expires|carbon_user_sessions\.session_data|carbon_user_sessions\.user_online_status))+\)*)+ *(as [a-z]+)?#i', $column);
    }
