...
class Wp_Comments extends Rest implements iRestSinglePrimaryKey
{
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to your columns found in wp_comments. Remember to regenerate when as all changes  
    ...
    */
    ...
    {   
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['comment_author'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_author\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_author_email, $comment_author_email === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_author_email\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_author_url, $comment_author_url === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_author_url\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_author_IP, $comment_author_IP === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_author_IP\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_date, $comment_date === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_date\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_date_gmt, $comment_date_gmt === '0000-00-00 00:00:00')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_date_gmt\'.');
        }
        $stmt->bindValue(':comment_date_gmt', $comment_date_gmt, PDO::PARAM_STR);
        
        if (!array_key_exists('wp_comments.comment_content', $data)) {
            throw new PublicAlert('The column \'wp_comments.comment_content\' is set to not null and has no default value. It must exist in the request and was not found in the one sent.');
        } 
        $ref='wp_comments.comment_content';
        $op = self::EQUAL;
        if (!self::validateInternalColumn(self::POST, $ref, $op, $data['comment_content'])) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_content\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_karma, $comment_karma === '0')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_karma\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_approved, $comment_approved === '1')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_approved\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_agent, $comment_agent === '')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_agent\'.');
        }
        ...
        if (!self::validateInternalColumn(self::POST, $ref, $op, $comment_type, $comment_type === 'comment')) {
            throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.comment_type\'.');
        }
        ...
        if (self::$commit && !Database::commit()) {
           throw new PublicAlert('Failed to store commit transaction on table wp_comments');
        }
    ...
    public static function Put(array &$returnUpdated, string $primary, array $argv) : bool
    {
        ...
        foreach ($argv as $key => &$value) {
            ...
            if (!self::validateInternalColumn(self::PUT, $key, $op, $value)) {
                throw new PublicAlert('Your custom restful api validations caused the request to fail on column \'wp_comments.\'.');
            }
        }
        unset($value);
