    ...
    */
    ...
    {   
        ...
        if (!array_key_exists('carbon_user_tasks.task_id', $argv)) {
            throw new PublicAlert('Required argument "carbon_user_tasks.task_id" is missing from the request.');
        }
        ...
        if (!array_key_exists('carbon_user_tasks.task_name', $argv)) {
            throw new PublicAlert('Required argument "carbon_user_tasks.task_name" is missing from the request.');
        }
