...
class ThrowableCatcher
{
    ...
    public static function checkCreateLogFile(string &$message): void
    {
        ...
        if (false === is_dir($directory) && (false === mkdir($directory, 0755, true) || false === is_dir($directory))) {
            ...
            throw new PublicAlert('The directory (' . $directory . ') for ThrowableCatcher::$defaultLocation (' . self::$defaultLocation . ') does not exist and could not be created');
    ...
    public static function grabCodeSnippet(): string
    {
        ...
        try {
            ...
            return '<div>Failed to load code preview in ThrowableCatcher class using ReflectionMethod.<div>';
    ...
    public static function start(): int
    {
        ...
        $error_handler = static function (int $errorLevel, string $errorString, string $errorFile, int $errorLine) {
            ...
            self::catchThrowable(null, false === $fatalError, (string)$errorLevel, $browserOutput, $warning ? iColorCode::YELLOW : iColorCode::RED);
        ...
        $exception_handler = static function (Throwable $exception) {
            ...
            self::catchThrowable($exception, false, null, $browserOutput, iColorCode::YELLOW);
    ...
    public static function stop(bool $ignoreRedundantStops = false): void
    {
        ...
        if (false === $ignoreRedundantStops && self::$old_error_level === null) {
             ...
             **/
            trigger_error('Looks like you are trying to run ThrowableCatcher::stop() before running start. This is not supported.', E_USER_WARNING);
     ...
     * @noinspection JsonEncodingApiUsageInspection
     */
    #[ArrayShape([self::LOG_ARRAY => "array", self::HTML_ERROR_PAGE => "string", self::STORED_HTML_LOG_FILE_PATH => "string"])]
    public static function catchThrowable(Throwable $e = null, bool $return = false, string $level = null, array &$log_array = [], string $color = iColorCode::RED): array
    {
        ...
        $log_array['[C6] CARBONPHP'] = 'ThrowableCatcher::catchThrowable';
    ...
    protected static function generateCallTrace(Throwable $e = null): array
    {
        ...
        if ($length === 0) {
            ...
            for ($i = 0; $i < $length; $i++) {
                ...
                if (false === str_ends_with($args[$i]['function'], '{closure}')) {
