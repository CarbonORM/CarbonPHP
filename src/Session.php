...
class Session implements SessionHandlerInterface
{
    ...
    public function open($savePath, $sessionName): bool
    {
        ...
        try {
            ...
            ThrowableCatcher::catchThrowable($e); // this will terminate
     ...
     * @throws PublicAlert
     */
    public function gc($maxLife) : int|false
    {
        ...
        $db->prepare('DELETE FROM ' . $session::TABLE_NAME . ' WHERE (UNIX_TIMESTAMP(' . $session::SESSION_EXPIRES . ') + ? ) < UNIX_TIMESTAMP(?)')->execute([$maxLife, date('Y-m-d H:i:s')]);
