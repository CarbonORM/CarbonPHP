...
abstract class RestfulValidations
{
    ...
    public static function validateGeneratedExternalSqlRequest(string $sql): void
    {
        ...
        throw new PublicAlert("The sql ($sql) is not valid. Please add it to the validSQL.json file. This is typically autogenerated by the frontend test cases. See the documentation for more information.");
