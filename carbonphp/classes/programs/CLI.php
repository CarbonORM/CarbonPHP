...
class CLI implements iCommand
{
    ...
    public function __construct(
        ...
        $searchAndConstruct = static function (array $array) use ($config, $program, $argv) {
            if (empty($array)) {
                return false;
            }
            ...
            foreach ($array as $fullyQualifiedProgramName) {
                ...
                $cmd = new $fullyQualifiedProgramName($config, $argv);
        ...
        if ($searchAndConstruct(self::$UserPrograms)
    ...
    public function programList(): void
    {
        try {
            ...
            if (!file_exists(CarbonPHP::$app_root.'composer.json')) {
            ...
            } elseif (false === CarbonPHP::$carbon_is_root) {
                ...
                foreach ($this->configuration->cliConfiguration->programs as $namespace) {
                    ...
                    if (!in_array(iCommand::class, class_implements($namespace), true)) {
