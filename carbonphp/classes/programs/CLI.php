...
class CLI implements iCommand
{
    ...
    public function programList(): void
    {
        ...
        try {
                ...
                foreach (self::$customProgramDirectories as $namespace => $programDirectory) {
                    ...
                    foreach ($userDefinedPrograms as $name) {
                        ...
                        if (false === class_exists($namespace . $name)) {
                            ...
                            ColorCode::colorCode("The file ($name) found under directory ($programDirectory) namespace ($namespace) could not be auto-loaded.\n Please check your composer.json file and configuration passe to CarbonPHP.", iColorCode::RED);
            ...
            $program = array_diff(
                scandir($programDirectory = __DIR__),
                array(
                    '.',
                    '..',
                    'CLI.php',
            ...
            foreach ($program as $name) {
                ...
                if (false === class_exists($namespace . $name)) {
                    ...
                    ColorCode::colorCode("The file ($name) found under directory ($programDirectory) namespace ($namespace) could not be auto-loaded! Please check your composer.json file and configuration passe to CarbonPHP.", iColorCode::RED);
