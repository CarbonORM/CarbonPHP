...
use CarbonPHP\Abstracts\Interfaces\iConfiguration;
use CarbonPHP\Abstracts\Tables\Carbons;
use CarbonPHP\Abstracts\Tables\Users;

class Documentation extends Application implements iConfiguration
{
    ...
    public static function configuration(): array
    {
        return [
            ...
            CarbonPHP::SITE => [
                ...
                CarbonPHP::VERSION     => trim(shell_exec('git tag | tail -n 1') ?? '0.0.0'),               // Add link to semantic versioning
            ...
            CarbonPHP::ERROR => [
                ...
                CarbonPHP::LEVEL    => E_ALL,  // php ini level
