...
trait RestTemplates
{
    public static function restTableClassTypeDefinition(): string
    {
        return /** @lang Handlebars */ <<<STRING
            ...
            use {{namespace}}\Traits\\t{{ucEachTableName}};
            
            // This is a 1=1 mapping to the columns found in {{TableName}}. It can be used with php 8 type system.
            class {{ucEachTableName}}_Columns
            {
                use t{{ucEachTableName}};
    ...
    public static function restTableTraitDefinition(): string
    {
