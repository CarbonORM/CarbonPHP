...
use CarbonPHP\Tables\Traits\Sessions_Columns;
...
class Sessions extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::USER_IP => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
