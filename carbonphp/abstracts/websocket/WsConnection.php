...
{
    public static function decodeWebsocket(&$connection): void
    {
    ...
    {
        $convert_memory_get_usage = static fn ($size) => round($size / (1024 ** ($i = floor(log($size, 1024)))), 2).' '.['b', 'kb', 'mb', 'gb', 'tb', 'pb'][$i];
