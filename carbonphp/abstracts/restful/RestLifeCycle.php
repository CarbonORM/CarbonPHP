...
use CarbonPHP\Abstracts\Error\PublicAlert;
...
use CarbonPHP\Abstracts\Session;
...
abstract class RestLifeCycle extends RestQueryBuilder
{
     ...
     * @see https://gist.github.com/nikic/5015323 -> https://www.npopov.com/2014/12/22/PHPs-new-hashtable-implementation.html
     *
     * @param array $return
     */
    ...
    public static function ExternalRestfulRequestsAPI(string $mainTable, ?string $primary = null, string $namespace = 'Tables\\', ?callable $postProcess = null): bool
    {
        ...
        try {
            echo PHP_EOL.json_encode($json, JSON_THROW_ON_ERROR).PHP_EOL;
        } catch (\Throwable $e) {
    ...
    public static function hijackRestfulRequest(array $return, bool $commitPendingTransactions = false): never
    {
        try {
            ...
            echo json_encode($return + $json, JSON_THROW_ON_ERROR);
