...
abstract class RestAutoTargeting extends RestSettings
{
    ...
    public static function getDynamicRestClass(string $fullyQualifiedRestClassName, ?string $mustInterface = null): string
    {
        try {
            ...
            } elseif (($mustInterface === iRestNoPrimaryKey::class || $mustInterface === null) && in_array(iRestNoPrimaryKey::class, class_implements($fullyQualifiedRestClassName), true)) {
            ...
            } elseif (($mustInterface === iRestMultiplePrimaryKeys::class || $mustInterface === null)
                && in_array(iRestMultiplePrimaryKeys::class, class_implements($fullyQualifiedRestClassName), true)
