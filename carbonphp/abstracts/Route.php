...
{
    /**
     * @var string full uri from server request['REQUEST_URI']
     *             back slash '\' as our delimiter
     */
    public static string $uri;

    /**
     * @var array will hold an exploded array with the
     *            back slash '\' as our delimiter
     */
    public static array $uriExplode;

    /**
     * @var int will hold the current number of fields
     *          separated by backslashes
     */
    public static int $uriLength;

    /**
     * @var bool|string will equal "true" if the
