...
abstract class Config extends TestCase
{
    ...
    public static function setupServerVariables(): void
    {
    ...
    public function setUp() : void /* The :void return type declaration that should be here would cause a BC issue */
    {
        ...
        define('APP_ROOT', SERVER_ROOT);

        // Composer autoload
        if (false === (include  APP_ROOT . 'vendor' . DS . 'autoload.php')) {     // Load the autoload() for composer dependencies located in the Services folder
            die(1);
        }

        // The app can exit here if a configuration failure exists
        new CarbonPHP(\Config\Config::class);
